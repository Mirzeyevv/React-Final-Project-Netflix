...
const Footer_SignIn = () => {
    ...
    return (
        <div className={`w-full max-w-[1440px] px-4 sm:px-8 md:px-20 lg:px-32 xl:px-[144px] relative mb-20  md:m-0 md:mt-72 font-bold md:font-medium`}>
